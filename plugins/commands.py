    ...
    if data.split("-", 1)[0] == "BATCH":
        ...
        for msg in msgs:
            ...
            try:
                ...
                filesarr.append(msg)
                k = await client.send_message(chat_id = message.from_user.id, text=f"<b><u>❗️❗️❗️IMPORTANT❗️️❗️❗️</u></b>\n\nThis Movie Files/Videos will be deleted in <b><u>10 mins</u> 🫥 <i></b>(Due to Copyright Issues)</i>.\n\n<b><i>👉Please forward this ALL Files/Videos to your Saved Masseges and Start Download there</i></b>.\n\n<b><i>👉 कृपया इस बोट से प्राप्त फाइल/विडियो को किसी सुरक्षित जगह फॉरवर्ड करें एवं वहां डाऊनलोड करे।</i></b>")

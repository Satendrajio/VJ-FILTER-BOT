...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002220078651 -1002177546858 -1002362691333').split()]
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002220078651 -1002177546858 -1002362691333')).split()]
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://inc-kendre-techumarshaikh-de41d4bc.koyeb.app/")

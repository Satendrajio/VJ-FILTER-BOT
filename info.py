...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002220078651 -1002177546858 -1002362691333 -1002303002913').split()]
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002220078651 -1002177546858 -1002362691333 -1002303002913')).split()]
